...
static const StatsDesc HothDesc = {
	{
		"GENDMG", "CODESTIME", "CCDMG", "TECHMAX", "KILL", "SHIELD", "SHIELDUPTIME", "ATSTKILL", "ATSTDMG"
	},
	{
		STAT_INT, STAT_DURATION, STAT_INT, STAT_INT_PAIR1, STAT_INT_PAIR2, STAT_INT, STAT_DURATION, STAT_INT, STAT_INT
	}
};
