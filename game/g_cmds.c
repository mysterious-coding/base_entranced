...
static const StatsDesc HothDesc = {
	{
		"ATSTKILL", "ATSTDMG", "GENDMG", "CCDMG", "CODESTIME", "TECHMAX", "KILL", "SHIELD", "SHIELDUPTIME"
	},
	{
		STAT_INT, STAT_INT, STAT_INT, STAT_INT, STAT_DURATION, STAT_INT_PAIR1, STAT_INT_PAIR2, STAT_INT, STAT_DURATION
	}
};
