...
#define SKILLBOOST_LEVEL2_DMGDEALTBONUS						(0.2f)
#define SKILLBOOST_LEVEL3_DMGDEALTBONUS						(0.4f)
#define SKILLBOOST_LEVEL1_DEMPDMGDEALTBONUS					(0.05f)
#define SKILLBOOST_LEVEL2_DEMPDMGDEALTBONUS					(0.1f)
#define SKILLBOOST_LEVEL3_DEMPDMGDEALTBONUS					(0.15f)

#define SKILLBOOST_LEVEL1_DMGTKNREDUCTION					(0.05f)
#define SKILLBOOST_LEVEL2_DMGTKNREDUCTION					(0.1f)
#define SKILLBOOST_LEVEL3_DMGTKNREDUCTION					(0.15f)

#define SKILLBOOST_LEVEL1_FORCEREGENBONUS					(0.1f)
#define SKILLBOOST_LEVEL2_FORCEREGENBONUS					(0.2f)
#define SKILLBOOST_LEVEL3_FORCEREGENBONUS					(0.4f)

#define SKILLBOOST_LEVEL1_DEMPMAXFROZENTIMEREDUCTION		(0.1f)
#define SKILLBOOST_LEVEL2_DEMPMAXFROZENTIMEREDUCTION		(0.2f)
#define SKILLBOOST_LEVEL3_DEMPMAXFROZENTIMEREDUCTION		(0.4f)

#define SKILLBOOST_LEVEL1_MOVEMENTSPEEDBONUS				(0.05f)
#define SKILLBOOST_LEVEL2_MOVEMENTSPEEDBONUS				(0.1f)
#define SKILLBOOST_LEVEL3_MOVEMENTSPEEDBONUS				(0.15f)

#define SKILLBOOST_LEVEL1_SELFDAMAGEFACTOROVERRIDE			(1.25f)
#define SKILLBOOST_LEVEL2_SELFDAMAGEFACTOROVERRIDE			(1.0f)
#define SKILLBOOST_LEVEL3_SELFDAMAGEFACTOROVERRIDE			(0.75f)

#define SKILLBOOST_LEVEL1_SPLASHRADIUSBONUS					(0.1f)
#define SKILLBOOST_LEVEL2_SPLASHRADIUSBONUS					(0.2f)
#define SKILLBOOST_LEVEL3_SPLASHRADIUSBONUS					(0.4f)
