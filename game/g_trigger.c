...
void Touch_Multi( gentity_t *self, gentity_t *other, trace_t *trace ) 
{
	...
	if (!Q_stricmp(self->target, "hangarplatbig1") && level.hangarCompleted == qfalse && other->client->sess.sessionTeam == TEAM_BLUE && (!Q_stricmp(mapname.string, "mp/siege_hoth2") || !Q_stricmp(mapname.string, "mp/siege_hoth")) && g_antiHothHangarLiftLame.integer && g_antiHothHangarLiftLame.integer >= 2)
	{
	...
	{//USE_BUTTON
		...
		if (!Q_stricmp(self->target,"hangarplatbig1") && (!Q_stricmp(mapname.string, "mp/siege_hoth2") || !Q_stricmp(mapname.string, "mp/siege_hoth")) && g_antiHothHangarLiftLame.integer &&
