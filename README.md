...
####base_entranced pk3 [[download newest version]](https://drive.google.com/file/d/0B-vLJdPP0Uo8a0FUS2JpQ2NoSnc/view?usp=sharing)
Version: base_entranced-12-10-2015-build76 (experimental) - allow duels in siege, add `removeFromOwnerOnUse`, add `removeFromGameOnUse`, add `despawnOnUse`
