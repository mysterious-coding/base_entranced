...
`xxxdmgx_jedisplashdmgreduction 1/0` - force this class use/not use the base JKA jedi 25% splash damage reduction (omit for default/base JKA default behavior)

`xxxdmgx_nonjedisaberdmgincrease 1/0` - force this class to use/not use the base JKA 4x saber damage (with max of 100) increase (omit for default/base JKA behavior)
